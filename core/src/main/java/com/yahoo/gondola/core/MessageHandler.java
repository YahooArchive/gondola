...
/**
 * The implementation methods in this class should not release the message. It is the responsibility of the caller to
 * release the message after these methods return.
 */
public abstract class MessageHandler {
    ...
    /**
     * This method is called for every command that has been batched in this message. Do not reuse 'message' to create a
     * reply since it will still be in use until all batches are handled.
     *
    ...
    /**
     * If success is true, matchIndex should be set to mnIndex. If success is false, nextIndex should be set to
     * mnIndex.
     */
